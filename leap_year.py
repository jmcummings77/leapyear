...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', type=str, nargs='?', default="./python_results.txt", help='File path for output.')
    parser.add_argument('-r', '--runprint', type=bool, nargs='?', default=False, help='Flag indicating whether to run tests for methods that print to the terminal.')
    args = parser.parse_args()
    # evaluate_performance(args.start, args.finish, args.output, args.iterations, args.runprint)
    evaluate_performance(1582, 240000, "./python_results.txt", 100, False)